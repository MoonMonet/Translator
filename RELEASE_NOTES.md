...
- **Fixed Version mismatch:** Now build workflow gonna change version based on what's written in workflow_dispatch so the issue with update banner showing up in latest version will never happen. (by [@gmcky](https://github.com/gmcky))
